...
# H2PY_ERR: h/libmnl/libmnl.h - define: MNL_NLMSG_HDRLEN = MNL_ALIGN(sizeof(struct nlmsghdr))
MNL_NLMSG_HDRLEN = MNL_ALIGN(sizeof(netlink.Nlmsghdr))

# H2PY_ERR: h/libmnl/libmnl.h - define: MNL_ATTR_HDRLEN = MNL_ALIGN(sizeof(struct nlattr))
MNL_ATTR_HDRLEN = MNL_ALIGN(sizeof(netlink.Nlattr))
...
MNL_CB_OK = 1
SOL_NETLINK = 270
def MNL_ARRAY_SIZE(a): return (sizeof(a)/sizeof((a)[0]))
